...
export default function Auth() {
  ...
  // Handle redirect callback from Google OAuth (when returning from accounts.google.com)
  useEffect(() => {
  ...
  const handleTriggerGoogle = () => {
    setError('');
    setLoading(true);
    // Direct Google OAuth 2.0 Web Navigation (Guaranteed to open Google's real device accounts picker)
  ...
  return (
    <div className="auth">
      <div className="auth__card animate-scaleIn">
        ...
        <div className="auth__socials" style={{ marginBottom: 'var(--space-md)' }}>
